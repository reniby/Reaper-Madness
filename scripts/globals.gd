...
var character_skin = [{
	"color": Color("b2c1caff"),
	"anim": "john"
},
{
	"color": Color("7fc1b5ff"), #cyan
	"anim": "kraken"
},
{
	"color": Color("b8b793ff"), #green
	"anim": "cyclops"
},
{
	"color": Color("c17caeff"), #pink
	"anim": "unga"
},
{
	"color": Color("c66152ff"), #red
	"anim": "john-alt"
},
{
	"color": Color("7e9edaff"), #blue
	"anim": "kraken-alt"
},
{
	"color": Color("8676d2ff"), #purple
	"anim": "cyclops-alt"
},
{
